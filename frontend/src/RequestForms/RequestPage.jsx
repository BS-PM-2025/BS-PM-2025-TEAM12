          ...
          {requestTypes.map((req) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className={`inline-flex items-center text-sm font-medium bg-gradient-to-r ${req.color} text-white px-4 py-2 rounded-lg group-hover:scale-105 transition-transform`}>
